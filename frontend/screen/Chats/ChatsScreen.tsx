import { useChatByUserId } from "@/frontend/hooks/useChats";
import {
  useInfiniteMessages,
  useMessages,
  useSendMessage,
} from "@/frontend/hooks/useMessages";
import MessageComponent from "../../components/Message";
import { useLocalSearchParams } from "expo-router";
import { Text, Button, View, TextInput, FlatList } from "react-native";
import { useEffect, useState } from "react";
import { useErrorActions } from "@/frontend/states_store/errorStore";
import { styles } from "@/utils/styles";
import ErrorOnSubmit from "@/frontend/components/ErrorOnSubmit";
